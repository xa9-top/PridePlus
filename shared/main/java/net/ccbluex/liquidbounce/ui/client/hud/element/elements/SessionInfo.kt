...
//额额 
    ...
    val fontValue = FontValue("Font", Fonts.font30)
    ...
    fun getClientColor(): Color {
        return Color(Gident!!.redValue.get(), Gident!!.greenValue.get(), Gident!!.blueValue.get())
    }

    fun getAlternateClientColor(): Color {
        return Color(Gident!!.redValue2.get(), Gident!!.greenValue2.get(), Gident!!.blueValue2.get())
    }
    ...
    private fun drawAnimatedPlaytime(playtimeX: Float, y: Float) {
        ...
        Fonts.font35.drawString("s", secondX, y + 24, -1)
        ...
        secondsSeparateWidthAnim1 = DrRenderUtils.animate(
            Fonts.font35.getStringWidth(secondsFirstPlace.toString()).toDouble(),
            secondsSeparateWidthAnim1.toDouble(),
            .05
        ).toFloat()
        secondX -= (secondsSeparateWidthAnim1 + .5).toFloat()
        for (i in 0..9) {
            Fonts.font35.drawString(i.toString(), secondX, y + 24 + i * 20 - secondYAnimation2, -1)
        }
        ...
        secondsSeparateWidthAnim2 = DrRenderUtils.animate(
            Fonts.font35.getStringWidth(secondsSecondPlace.toString()).toDouble(),
            secondsSeparateWidthAnim2.toDouble(),
            .05
        ).toFloat()
        secondX -= (secondsSeparateWidthAnim2 + .5).toFloat()
        for (i in 0..9) {
            Fonts.font35.drawString(i.toString(), secondX, y + 24 + i * 20 - secondYAnimation1, -1)
        }
        if (playTime[1] > 0) {
            var minuteX = playtimeX + playtimeWidth - 27
            Fonts.font35.drawString("m", minuteX, y + 24, -1)
            ...
            minuteSeparateWidthAnim1 = DrRenderUtils.animate(
                Fonts.font35.getStringWidth(minuteFirstPlace.toString()).toDouble(),
                minuteSeparateWidthAnim1.toDouble(),
                .05
            ).toFloat()
            minuteX -= (minuteSeparateWidthAnim1 + .5).toFloat()
            for (i in 0..9) {
                Fonts.font35.drawString(i.toString(), minuteX, y + 24 + i * 20 - minuteYAnimation1, -1)
            }
            ...
            minuteSeparateWidthAnim2 = DrRenderUtils.animate(
                Fonts.font35.getStringWidth(minuteSecondPlace.toString()).toDouble(),
                minuteSeparateWidthAnim2.toDouble(),
                .05
            ).toFloat()
            minuteX -= (minuteSeparateWidthAnim2 + .5).toFloat()
            for (i in 0..9) {
                Fonts.font35.drawString(i.toString(), minuteX, y + 24 + i * 20 - minuteYAnimation2, -1)
            }
            if (playTime[0] > 0) {
                hourYAnimation =
                    DrRenderUtils.animate((20 * (playTime[0] % 10)).toDouble(), hourYAnimation.toDouble(), .02)
                        .toFloat()
                Fonts.font35.drawString("h", playtimeX + playtimeWidth - 44, y + 24, -1)
                for (i in 0..9) {
        ...
        when (modeValue.get().toLowerCase()) {
            "normal" -> {
                ...
                RenderUtils.drawGradientSideways(
                    ...
                    Color(Gident.redValue.get(), Gident.greenValue.get(), Gident.blueValue.get()).rgb,
                    Color(Gident.redValue2.get(), Gident.greenValue2.get(), Gident.blueValue2.get()).rgb
                )
            ...
            "tenacity" -> {
                ...
                val height: Float = (linesLeft.size * (Fonts.font35.fontHeight + 6) + 24).toFloat()
                val width = 140f
                ...
                Fonts.font40.drawCenteredString(
                    "Statistics",
                    (x + width / 2).toDouble().toFloat(),
                    (y + if (colorMode.get() == "Modern") 3 else 2).toDouble().toFloat(),
                    -1
                )
                

                for (i in linesLeft.indices) {
                    val offset: Int = i * (Fonts.font35.fontHeight + 6)
                    Fonts.font35.drawString(
                        linesLeft[i],
                        x + 5,
                ...
                if (animatedPlaytime.get()) {
                    ...
                    Fonts.font35.drawString(
                        playtimeString,
                        playtimeX + playtimeWidth - Fonts.font35.getStringWidth(playtimeString),
                        y + 24,
                        -1
                    )
                }

                val linesRight = listOf(Recorder.totalPlayed.toString(), Recorder.killCounts.toString())

                for (i in linesRight.indices) {
                    val offset = (i + 1) * (Fonts.font35.fontHeight + 6)
                    Fonts.font35.drawString(
                        linesRight[i], x + width - (Fonts.font35.getStringWidth(
                            linesRight[i]
                        ) + 5), y + offset + 25, -1
                    )
                }
