...
@ModuleInfo(name = "FollowTargetHud",description="followtargethud", category = ModuleCategory.RENDER)
class FollowTargetHud : Module() {
    private val modeValue = ListValue("Mode", arrayOf("Juul", "Jello", "Material", "Arris", "FDP"), "Juul")
    private val fontValue = FontValue("Font", Fonts.bold30)
